...
namespace CarBaoYang
{
    public static class EntityExtension
    {
        ...
        /// <returns></returns>
        public static string GetUpdateSQL<T>(this T t, string PrimaryKeys, string tableName, string clumns = "", bool exclude = false)
        {
        ...
        public static string GetBulkUpdateSQL<T>(this IEnumerable<T> ts, string PrimaryKeys, string tableName, string clumns = "", bool exclude = false)
        {
        ...
        public static string GetInsertSQL<T>(this T t, string tableName, string clumns = "", bool exclude = false)
        {
            if (t == null) { return null; }
            List<string> excludeColumns = new List<string>();
            if (!string.IsNullOrEmpty(clumns))
        ...
        public static string GetBulkInsertSQL<T>(this IEnumerable<T> ts, string tableName, string clumns = "", bool exclude = false)
        {
            List<string> excludeColumns = new List<string>();
            if (!string.IsNullOrEmpty(clumns))
            {
        ...
        public static string GetReplaceIntoSQL<T>(this T t,string tableName,string clumns="",bool exclude=false)
        {
            if (t == null) { return null; }
            List<string> excludeColumns = new List<string>();
            if (!string.IsNullOrEmpty(clumns))
            ...
            PropertyInfo[] pros = t.GetType().GetProperties();
            string InsertSQL = "Replace into `{0}` ({1}) values({2});";
            StringBuilder sb_Columns = new StringBuilder();
            StringBuilder sb_Values = new StringBuilder();
            foreach (var item in pros)
            {
